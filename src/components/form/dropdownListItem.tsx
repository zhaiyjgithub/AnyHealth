...
function DropdownListForm(props: IProps) {
    const {disabled = false, id, data, onChange} = props
                ...
                {({open}) => {
                    return (
                        <div className="relative w-full">
                            <Listbox.Button className={`z-10 w-full btn ${!disabled ? "btn-outline" : "btn-disabled"} ${open ? "ring-2 ring-offset-2 ring-gray-500" : ""} btn-sm relative cursor-default rounded-full inline-flex`}>
