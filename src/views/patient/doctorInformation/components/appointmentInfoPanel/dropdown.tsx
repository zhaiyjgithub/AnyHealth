...
export default function Dropdown(props: IProps) {
    ...
    const $toggleButton = (
        ...
        className={"w-full z-10 mt-1 relative p-3 bg-white flex flex-row items-center justify-between border border-gray-300 text-primary-focus font-semibold text-lg leading-tight"}>
    ...
    const $list = show ? (
        <div
            className="absolute right-0 overflow-y-auto border mt-1 min-w-full bg-white shadow-2xl z-20 transition duration-150 ease-in-out max-h-96">
            {$insuranceList}
        </div>
    ) : null
