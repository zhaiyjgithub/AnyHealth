    ...
    return (
        <div>
            ...
            <div className={"space-y-8 mt-4"}>
                ...
                <div>
                    <p className={"text-base text-primary-focus font-semibold"}>What are common reasons for patients to
                        see Dr. Binh Dang?</p>
                    <p className={"text-base text-primary-focus "}>
                        Dr. Binh Dang frequently sees patients for Allergy Consultation, Annual Pap Smear / GYN Exam,
                        Annual Physical, Illness, and Pediatric Consultation. You can
                        <span className={"text-blue-500 mx-1"}>
                ...
                <div>
                    <p className={"text-base text-primary-focus font-semibold"}>What languages does Dr. Binh Dang
                        speak?</p>
                    <p className={"text-base text-primary-focus "}>
                        <span className={"text-blue-500 mx-1"}>
                          Dr. Binh Dang
                ...
                <div>
                    <p className={"text-base text-primary-focus font-semibold"}>How do patients rate Dr. Binh Dang in
                        reviews?</p>
                    <p className={"text-base text-primary-focus "}>
                        121 patients have reviewed Dr. Binh Dang. The overall rating for this doctor is 3.56/5. They
                        have a 3.85/5 rating for bedside manner and a 3.78/5 rating for wait time. You can
                        <span className={"text-blue-500 mx-1"}>
