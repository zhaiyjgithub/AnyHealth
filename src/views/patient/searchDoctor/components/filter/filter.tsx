...
export default function Filter() {
    ...
    const $toggleButtonForMoreFilter = (
        ...
        className={`z-10 relative px-4 py-2 font-semibold rounded-full flex flex-row items-center border text-primary-focus text-sm leading-tight hover:bg-base-250 hover:border-primary-focus ${showMoreFilter || languages.length ? "border-primary-focus bg-base-250" : "border-base-300 bg-white"}`}>
            More filters
        </button>
    )
